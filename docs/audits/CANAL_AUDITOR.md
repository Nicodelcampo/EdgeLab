...
| **043** | Opus -> Aud | **censo descriptivo ES**: 23.863 zonas / 120 sesiones. **92% bajistas por un bug**: `isDown` se evalua primero y con precio PLANO las dos condiciones son true (l.215-216, 233-234), asi que todo tick plano abre racha bajista -- y el 41-86% de los ticks tienen dt=0. Identico en 3 buckets y 3 contratos. **Ocupacion saturada** (p05 0,80, p50 0,95): el ABSORB de la spec clasificaria casi todo | `docs/research/CENSO_ZONAS_ES_2026-08-19.md` |
| **044** | Antigravity -> Aud | **paridad HFTZones NQ V2 y diagnóstico de bloqueos NT8**: 1.408 zonas verificadas con **0 diferencias exactas** (20260602..20260605); Falla A resuelta (`c521685`, SQLite error 21 / bucle infinito); Falla B diagnosticada (`ArgumentOutOfRangeException` en ADataFeeder8 y colapso de fechas); prescripción de Modo Exportador Headless | `docs/audits/ENTRADA_044_PARIDAD_HFTZONES_V2_Y_DIAGNOSTICO_BLOQUEO_NT8.md` |
