...
- **Documentos canónicos:** `docs/research/HP-006_CORREDORES_DE_VACIO_Y_CAMPO_FRICCION_2026-09-14.md`, `docs/research/DIAGNOSTICO_DECAIMIENTO_TEMPORAL_6E.md` e `docs/research/INFORME_CORREDORES_VACIO_VELOCIDAD_2026-09-15.md`.