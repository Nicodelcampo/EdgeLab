...
- Diagnóstico de Heterogeneidad Horaria GC V1: en preparación fail-closed (`specs/bt2a_p2a_gc_clock_heterogeneity_v1.json`, rama `research/bt2a-p2a-clock-heterogeneity-v1-20260827`).
