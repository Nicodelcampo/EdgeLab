...
- **Conclusión sobre el Baseline:** Las salidas de `510 passed` que el proyecto usó como baseline en la última quincena **no se midieron sobre este intérprete** o son apócrifas. (El inventario de la máquina reveló otros entornos aislados, como `.venv` de proyectos hermanos, que sí cumplen).
...
- Baseline **510 passed, 3 deselected** reproducido en entorno limpio. ✅
- §94 pasa de **provisional** a **firme**. ✅
- INC-003 **cerrado**.
