...
| M13 | **F1.1** nulo contra zonas aleatorias, dos diseños (posición libre / desplazamiento local) | **tocar: real 97,9 % vs nulo-B 50,6 % — 201/201 sesiones, brecha pareada 47,3pp.** Romper: casi igual (0,54 pp) | `F1_nulo_zonas_aleatorias__260757be9e71.json` (corregido; el original `ac9d001dc815` con el bug de redondeo queda en `diag/tasa_senales/incidentes/INCIDENTE_altura_de_zona_con_ruido_de_redondeo__ac9d001dc815.json`, no borrado) |
